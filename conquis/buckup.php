...
<?php
    ...
    $query1 = "select * from clubes";                                            //Sql a ejecutar
...
?>
        ...
        <div data-role="page" id="unete">
            ...
            <div data-role="content">	
                ...
                <form id="form_unete" action="form_unete.php" method="get" class="ui-body ui-body-a ui-corner-all">
                    ...
                    <div data-role="fieldcontain">
                        ...
                        <select name='cargo' id='cargo'>
                            ...
                            <?php echo $option_roles; ?>                             <!--Imprimimos la lista de clubes generada anteriormente-->
                        </select>
                    </div>
                    ...
                    <div data-role="fieldcontain">
                        <label for="password2" class="ui-hidden-accessible">Repita Contraseña:</label>
                        <input type="password" name="password2" id="password2" value="" placeholder="Repita su Contraseña"/>
                    </div>
                ...
                <form id="form_club" method="" action="" class="ui-body ui-body-a ui-corner-all">
                    ...
                    <div data-role="fieldcontain">
                        ...
                        <select name="iglesia" id="iglesia">
                            <option value="rejas_sur">Rejas Sur</option>
                            <option value="rejas_norte">Rejas Norte</option>
